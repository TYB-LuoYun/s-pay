package com.dicomclub.module.pay.service.wxpay;
...
import com.dicomclub.module.pay.constants.WxPayConstants;
...
import com.dicomclub.module.pay.model.wxpay.WxPayApi;
import com.dicomclub.module.pay.model.wxpay.WxPayRequest;
import com.dicomclub.module.pay.model.wxpay.WxPayResponse;
import com.dicomclub.module.pay.model.wxpay.request.WxPayUnifiedorderRequest;
import com.dicomclub.module.pay.model.wxpay.response.WxPayAsyncResponse;
import com.dicomclub.module.pay.model.wxpay.response.WxPaySyncResponse;
import com.dicomclub.module.pay.service.PayStrategy;
import com.dicomclub.module.pay.service.wxpay.channel.WxPayMicroService;
import com.dicomclub.module.pay.service.wxpay.common.WxPaySignature;
import com.dicomclub.util.MapUtil;
import com.dicomclub.util.MoneyUtil;
import com.dicomclub.util.RandomUtil;
import com.dicomclub.util.XmlUtil;
...
public class WxPayStrategy extends PayStrategy {
    ...
    public PayResponse pay(PayRequest payRequest , PayConfig payConfig) {
        ...
        if (request.getPayChannel() == PayChannel.WXPAY_MICRO) {
            WxPayMicroService wxPayMicroService = new WxPayMicroService(wxPayConfig);
