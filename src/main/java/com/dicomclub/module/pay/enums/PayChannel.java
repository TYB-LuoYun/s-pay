package com.dicomclub.module.pay.enums;


import lombok.AllArgsConstructor;
import lombok.Getter;

import static com.dicomclub.module.pay.enums.PayType.ALIPAY;
import static com.dicomclub.module.pay.enums.PayType.UNION;
import static com.dicomclub.module.pay.enums.PayType.WX;
...
//  条码付 (用户付款码支付)
    ...
    UNION_WEB_GATEWAY("UNION_PC_GATEWAY",UNION,"银联PC/平板在线网关支付"),
//  企业网银(B2B)过时了，我就不列了

    UNION_MOBILE_WAP("UNION_MOBILE_WAP",UNION,"银联手机网页WAP支付"),


    UNION_B2B("UNION_B2B",UNION,"企业网银支付(过时，建议在线网关支付)"),

    /**
     * 持卡人仅需使用支持银联标准的APP扫
     * https://open.unionpay.com/tjweb/acproduct/list?apiservId=468
     */
    UNION_QRCODE("UNION_QRCODE",UNION,"申码，扫码付-主扫场景"),

    UNION_CONSUME_BARCODE("UNION_CONSUME_BARCODE",UNION,"消费(被扫场景)")
