package com.dicomclub.util.httpRequest;
...
import static com.dicomclub.util.httpRequest.UriVariables.getMapToParameters;
...
/*            String charset = "UTF-8";
            ...
            if (isJson(contentType[0], first)) {
                try {
                    ...
                    throw new RuntimeException("failure "+ String.format("类型转化异常,contentType: "+ entity.getContentType().getValue(), e.getMessage())+result);
                }
            }
            //xml类型
            ...
            throw new RuntimeException("failure"+ "类型转化异常,contentType:" + entity.getContentType().getValue()+ result);
        }

        throw new RuntimeException( "failure"+ "类型转化异常,contentType:" + entity.getContentType().getValue());
    }
