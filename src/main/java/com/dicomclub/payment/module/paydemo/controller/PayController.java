...
import com.dicomclub.payment.module.pay.model.AllPayRequest;
...
//      单商户 统一类型和 渠道 支付
         ...
         * 单独使用支付宝策略 渠道支付
         */
        PayStrategy payStrategy = new AliPayStrategy();
        payStrategy.pay(new AliPayRequest(),new AliPayConfig());
