...
public class WxTransferDetail {
    ...
    public WxTransferDetail() {
    }

    public WxTransferDetail(String outDetailNo, Integer transferAmount, String transferRemark, String openid) {
